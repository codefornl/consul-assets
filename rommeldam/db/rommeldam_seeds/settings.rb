section "Instellingen maken" do
  ...
  Setting.create(key: 'url', value: 'https://rommeldam.codefor.nl')
  Setting.create(key: 'org_name', value: 'Gemeente Rommeldam')
  Setting.create(key: 'place_name', value: 'Rommeldam')
  ...
  Setting.create(key: 'comments_body_max_length', value: '1000')
  Setting.create(key: 'mailer_from_name', value: 'Rommeldam')
  Setting.create(key: 'mailer_from_address', value: 'no-reply@codefor.nl')
  Setting.create(key: 'meta_title', value: 'CONSUL')
  Setting.create(key: 'meta_description', value: '')
  Setting.create(key: 'meta_keywords', value: '')
  Setting.create(key: 'verification_offices_url', value: 'http://organisatie.rommeldam.nl/')
