  ...
  Poll.find_each do |poll|
    ...
    I18n.available_locales.map do |locale|
      Globalize.with_locale(locale) do
        ...
        poll.summary = "Samenvatting in #{locale}"
        poll.description = "Omschrijving in #{locale}"
      end
    end
    poll.save!
  end
...
section "Stemlocaties" do
  20.times do |i|
    Poll::Booth.create(name: "Stemlocatie #{i}",
                       location: Faker::Address.street_address,
                       polls: [Poll.all.sample])
  end
end

section "Piket instellen" do
  Poll.find_each do |poll|
