...
section "Gearchiveerde ideen maken" do
  tags = Faker::Lorem.words(25)
  5.times do
    author = User.all.sample
    description = "<p>#{Faker::Lorem.paragraphs.join('</p><p>')}</p>"
...
section "Gelukte ideeen maken" do
  tags = Faker::Lorem.words(25)
  10.times do
    author = User.all.sample
    description = "<p>#{Faker::Lorem.paragraphs.join('</p><p>')}</p>"
...
section "Notificaties voor ideen maken" do
  100.times do |i|
    ProposalNotification.create!(title: "Idee notificatie titel #{i}",
                                 body: "Idee notificatie test #{i}",
                                 author: User.all.sample,
