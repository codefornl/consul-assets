...
section "Budgetten maken" do
  Budget.create(
    name_nl: "#{I18n.t("seeds.budgets.budget", locale: :nl)} #{Date.current.year - 1}",
    currency_symbol: I18n.t("seeds.budgets.currency"),
    phase: "finished"
  )

  Budget.create(
    name_nl: "#{I18n.t("seeds.budgets.budget", locale: :nl)} #{Date.current.year}",
    currency_symbol: I18n.t("seeds.budgets.currency"),
    phase: "accepting"
  )
  ...
  Budget.all.each do |budget|
    city_group_params = {
      name_nl: I18n.t("seeds.budgets.groups.all_city", locale: :nl)
    }
    ...
    districts_group_params = {
      name_nl: I18n.t("seeds.budgets.groups.districts", locale: :nl)
    }
    districts_group = budget.groups.create!(districts_group_params)

    north_heading_params = {
      name_nl: I18n.t("seeds.geozones.north_district", locale: :nl),
    ...
    west_heading_params = {
      name_nl: I18n.t("seeds.geozones.west_district", locale: :nl),
      price: rand(5..10) * 100000,
      population: 300000,
      latitude: "40.416775",
      longitude: "-3.703790"
    ...
    east_heading_params = {
      name_nl: I18n.t("seeds.geozones.east_district", locale: :nl),
      price: rand(5..10) * 100000,
      population: 200000,
      latitude: "40.416775",
      longitude: "-3.703790"
    ...
    central_heading_params = {
      name_nl: I18n.t("seeds.geozones.central_district", locale: :nl),
      price: rand(5..10) * 100000,
      population: 150000,
      latitude: "40.416775",
      longitude: "-3.703790"
...
section "Investeringen maken" do
...
section "Investeringen zichtbaar maken" do
